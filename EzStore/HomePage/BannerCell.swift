...
class BannerCell: UITableViewCell , UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    let bannerImage: [UIImage] = [#imageLiteral(resourceName: "banner1"), #imageLiteral(resourceName: "banner6"), #imageLiteral(resourceName: "banner5"), #imageLiteral(resourceName: "banner2"), #imageLiteral(resourceName: "banner3"), #imageLiteral(resourceName: "banner4")]
